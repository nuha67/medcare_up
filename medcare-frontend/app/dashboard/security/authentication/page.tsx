...
export default function DeviceAuthPage() {
  ...
  const fetchInitialData = async (token: string) => {
    try {
      ...
      const profileRes = await axios.get("https://34-229-165-55.nip.io/patients/me/profile", {
      ...
      const sessionsRes = await axios.get("https://34-229-165-55.nip.io/auth/sessions/me", {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleToggleEmailMfa = async () => {
    ...
    try {
      ...
      await axios.post(`https://34-229-165-55.nip.io/auth/mfa/toggle-email?enable=${newState}`, {}, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleVerifyAppMfa = async () => {
    ...
    try {
      const token = localStorage.getItem("medcare_token");
      await axios.post("https://34-229-165-55.nip.io/auth/mfa/verify-app", 
