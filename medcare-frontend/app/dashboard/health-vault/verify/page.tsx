...
export default function ReportVerificationPage() {
  ...
  useEffect(() => {
    ...
    const fetchProfile = async () => {
      try {
        const response = await axios.get("https://34-229-165-55.nip.io/patients/me/profile", {
  ...
  const handleVerifyReport = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post("https://34-229-165-55.nip.io/patients/verify-report", formData, {
        headers: { 
