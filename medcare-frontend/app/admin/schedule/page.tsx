...
export default function ScheduleManagementPage() {
  ...
  useEffect(() => {
    ...
    axios.get("https://34-229-165-55.nip.io/admin/users/", { headers: { Authorization: `Bearer ${token}` } })
  ...
  const selectDoctor = async (username: string, fullName: string) => {
    ...
    try {
      const res = await axios.get(`https://34-229-165-55.nip.io/admin/schedules/doctor/${username}`, {
  ...
  const handleSaveSchedule = async (e: React.FormEvent) => {
    ...
    try {
      await axios.post("https://34-229-165-55.nip.io/admin/schedules/", {
